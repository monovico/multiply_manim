...
class xd123(Scene):
    def construct(self):
        ...
        self.play(Indicate(t[0], color = RED), Indicate(r1, color = RED, scal_factor = 0.3))
        self.play(Indicate(t[1], color = RED), Indicate(r2, color = RED, scal_factor = 0.3))
        self.play(Indicate(t[2], color = RED), Indicate(r3, color = RED, scal_factor = 0.3))
        self.play(Indicate(t[3], color = RED), Indicate(r4, color = RED, scal_factor = 0.3))
        self.play(Indicate(t[4], color = RED), Indicate(r5, color = RED, scal_factor = 0.3))

        d = Dot(color = RED)

        g3 = VGrroup(group, t, s1, s2)
